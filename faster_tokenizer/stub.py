...
def fn_predicate(obj):
    ...
    if value:
        return obj.__doc__ and obj.__text_signature__ and not obj.__name__.startswith(
            "_")
...
def write(module, directory, origin, check=False):
    submodules = [(name, member) for name, member in inspect.getmembers(module)
...
if __name__ == "__main__":
    ...
    write(faster_tokenizer.core_tokenizers,
          "python/faster_tokenizer/",
          "faster_tokenizer",
          check=args.check)
